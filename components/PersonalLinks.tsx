            ...
            <div className="relative z-10 flex justify-between items-start">
                <div className="flex items-center gap-2 text-sm font-medium">
                    <svg className="w-5 h-5 fill-current text-blue-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.979 0C5.678 0 .511 4.86 0 11.159c.402.013.719.07 1.05.211l3.493 1.444c.71-.33 1.507-.485 2.276-.44l.01.01 2.302-3.376C9.016 8.949 9 8.87 9 8.78c0-1.54 1.26-2.8 2.81-2.8 1.55 0 2.81 1.26 2.81 2.8 0 1.55-1.26 2.81-2.81 2.81-.13 0-.25-.01-.38-.03l-3.356 2.308c.012.15.018.298.018.45 0 2.26-1.84 4.1-4.1 4.1-.46 0-.9-.08-1.31-.22l-2.99 1.236c1.742 2.484 4.639 4.113 7.917 4.113 5.33 0 9.66-4.33 9.66-9.66 0-5.33-4.33-9.66-9.66-9.66zm.021 6.833a1.947 1.947 0 0 1 1.947 1.947 1.947 1.947 0 0 1-1.947 1.947 1.947 1.947 0 0 1-1.947-1.947 1.947 1.947 0 0 1 1.947-1.947zm-5.053 5.34a2.153 2.153 0 0 1 2.153 2.153 2.153 2.153 0 0 1-2.153 2.153 2.153 2.153 0 0 1-2.153-2.153 2.153 2.153 0 0 1 2.153-2.153z"/>
                    </svg>
                    <span>{link.platform}</span>
                </div>
